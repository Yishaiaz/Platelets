...
DELTA_MIN_VALUE = -30
DELTA_BINS_NUM = 61
VideoFilesIntensityDynamicsOverTimeResultsPath = "/Users/yishaiazabary/PycharmProjects/platelets/DetachmentEventPlots/RunningTImeVideoFRAMES"
VideoFilesToProcessIntensityDynamicsOverTimePath = "/Users/yishaiazabary/PycharmProjects/platelets/DetachmentEventPlots/RunningTImeVideoAVI"
...
def saving_png_files_as_videos(directory_path: str):
    ...
    out = cv2.VideoWriter("{0}/to_name.avi".format(VideoFilesIntensityDynamicsOverTimeResultsPath),
...
saving_png_files_as_videos("{0}".format(VideoFilesIntensityDynamicsOverTimeResultsPath))
